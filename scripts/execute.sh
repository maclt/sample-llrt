# Copy from https://github.com/alexcasalboni/aws-lambda-power-tuning/tree/master/scripts

#!/bin/zsh
# config
STACK_NAME=TaroLLRTTunerStack-powerTuner-15GRPWE5H02WX # replace with your stack name
INPUT=$(cat scripts/execution-input.json)  # or use a static string
